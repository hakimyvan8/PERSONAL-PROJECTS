...
$supplierState = $row_admin['supplierState'];

$supplierDistrict = $row_admin['supplierDistrict'];
...
<td><?php echo $supplier_district; ?></td>
    ...
    <td><?php echo $supplierState; ?></td>
    
    <td><?php echo $supplierDistrict; ?></td>
...
<td>
    <a href="index.php?edit_item=<?php echo $supplier_id; ?>">
