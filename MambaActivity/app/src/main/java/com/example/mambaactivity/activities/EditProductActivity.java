...
public class EditProductActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        //if discountSwitch is checked: show discountPriceEt, discountNoteEt | if discountedSwitch is not checked: hide discountPriceEt, discountNoteEt
        discountSwitch.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton buttonView, boolean isChecked)
            {
                if (isChecked)
                {
                    //checked, show discountPriceEt, discountNotedEt
        ...
        reference.child(firebaseAuth.getUid()).child("Products").child(productId)
                .addValueEventListener(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot)
                    {
                        ...
                        try {
                            Picasso.get().load(productIcon).placeholder(R.drawable.ic_cart2).into(productIconIv);
                        }
                        catch (Exception e){
    ...
    private void updateProduct()
    {
        ...
        else
        {
            ...
            String filePathAndName = "product_images/"+""+productId;//overide previous image same id
            //upload image
