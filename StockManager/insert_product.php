...
if(isset($_POST['submit'])) {
    ...
    $insert_product = "insert into products (p_cat_id,date,product_title,product_img1,product_price,product_desc,status,unitsStored,RemainingUnits) values ('$product_cat',NOW(),'$product_title','$product_img1','$product_price','$product_desc','$status','$product_units','$product_RemUnits')";
