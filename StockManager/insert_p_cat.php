...
<textarea name="catproduct_desc" class="form-control" rows="15" id="product_desc">
...
$catproduct_desc = $_POST['catproduct_desc'];
...
$insert_p_cat = "insert into product_categories (p_cat_title,p_cat_top,catproduct_desc,p_cat_image) values ('$p_cat_title','$p_cat_top','$catproduct_desc','$p_cat_image')";
